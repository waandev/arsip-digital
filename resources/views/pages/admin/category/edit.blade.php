        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Kategory</h3>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="fa fa-edit"></i> Form Kategori</h4>
                                                ...
                                                <div class="form-group row {{ $errors->has('name') ? 'has-error' : '' }}">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="name" name="name"
                                                            ...
                                                            placeholder="example Curriculum Vitae"
                                                ...
                                                <div
                                                    class="form-group row {{ $errors->has('description') ? 'has-error' : '' }}">
                                                    <label class="col-md-3 label-control">Keterangan <code
                                                            style="color:red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <textarea type="text" id="description" name="description" class="form-control"
                                                            placeholder="example This is new description..." autocomplete="off" required>{{ old('name', isset($category) ? $category->description : '') }}</textarea>
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('admin.category.index') }}" style="width:120px;"
