        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" href="#"><img class="brand-logo"
                            ...
                            src="{{ asset('/assets/templates/app-assets/images/logo/logo.png') }}">
                        <h3 class="brand-text">Arsip Digital</h3>
                    </a></li>
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                            href="#" data-toggle="dropdown"><span
                                ...
                                class="avatar avatar-online"><img
                                    src="{{ asset('/assets/templates/app-assets/images/portrait/small/avatar-s-19.png') }}"
